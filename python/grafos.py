...
pos = nx.fruchterman_reingold_layout(g_orientandos, k=0.15)
nx.draw_networkx_nodes(g_orientandos, pos, node_size=70, node_color="green")
nx.draw_networkx_edges(g_orientandos, pos, alpha=0.3)
plt.title("Grafo com Colaboraçãos entre Orientados")
plt.show()
