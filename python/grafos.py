...
nx.draw_networkx_edges(g_pesquisadores_autores, pos, alpha=3.0)
...
nx.draw_networkx_edges(g_pesquisadores_orientados, pos, alpha=3.0)
...
nx.draw_networkx_edges(g_com_todos_os_individuos, pos, alpha=3.0)
...
nx.draw_networkx_edges(g_orientandos, pos, alpha=3.0)
plt.title("Grafo com Pesquisadores, Autores e Orientados de Mestrado e Doutorado")
plt.show()
